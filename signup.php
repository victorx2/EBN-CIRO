      ...
      <div class="row g-0">
        <div class="card-body p-md-5 mx-md-4">
          <div class="mt-1 mb-2 pb-1">
            ...
            <center>
            <div class="mt-1 mb-2 pb-1">
              <img src="img/Retro.png" alt="logo" style="width:15%"class="align-content-lg-center">
            </div>
            </center>
        ...
        <div class="col-sm-12">
          <div class="form-group row">
            ...
            <div class="col form-outline mb-4">
              <label class="form-label d-flex justify-content-center" for="usuario">USUARIO</label>
              <input type="text" id="usuario" name="usuario" class="form-control"
                placeholder="NOMBRE DE USUARIO" required>
            </div>

            <div class="col">
              <label class="form-label d-flex justify-content-center" for="cedula">CEDULA</label>
              <input type="text" name="cedula" id="cedula" class="form-control" pattern="[0-9]+"
                maxlength="9" placeholder="CEDULA DEL USUARIO" required>
            </div>
          </div>
        </div>
      </div>
              ...
              <div class="row">
                <div class="col-sm-12">
                  <div class="form-group row">
                    ...
                    <div class="col form-outline mb-4">
                      <label class="form-label d-flex justify-content-center" for="clave">CONTRASEÑA</label>
                    ...
                    <div class="col form-outline mb-2">
                      <label class="form-label d-flex justify-content-center" for="confirm_clave">CONFIRMAR CONTRASEÑA</label>
                      <input type="password" id="confirm_clave" class="form-control" name="confirm_clave"
                ...
                <div class="col-sm-12">
                  <div class="form-group row">
                    ...
                    <div class="col form-check">
                      ...
                      <input class="form-check-input" type="radio" name="nivel" id="nivelA1" value="A" onchange="mostrarFormulario5()">
                    ...
                    <div class="col form-check">
                      ...
                      <input class="form-check-input" type="radio" name="nivel" id="nivelI1" value="I" onchange="mostrarFormulario5()">
                ...
                <div class="px-3 py-4 p-md-5 mx-md-4">
                          ...
                          <div class="col-sm-12">
                            <div class="form-group row">
                              ...
                              <div class="col">
                                ...
                                <input type="text" name="nombre1" id="nombre1" pattern="[a-zA-Z]*" class="form-control">
                              </div>
                              <br>
                              <div class="col">
                                <label for="nombre2">Segundo Nombre:</label>
                                <input type="text" name="nombre2" id="nombre2" pattern="[a-zA-Z]*" class="form-control">
                              </div>
                          ...
                          <div class="col-sm-12">
                            <div class="form-group row">
                              ...
                              <div class="col">
                                ...
                                <input type="text" name="apellido1" id="apellido1" pattern="[a-zA-Z]*" class="form-control">
                              </div>
                              <br>
                              <div class="col">
                                <label for="apellido2">Segundo Apellido:</label>
                                <input type="text" name="apellido2" id="apellido2" pattern="[a-zA-Z]*" class="form-control">
                              </div>
                  ...
                  <div class="card shadow mb-4" id="nivelA1Abajo2" style="display:none;">
                    <div class="card-body">
                      ...
                      <center>
                      <button type="submit" class="btn btn-outline-primary col-2 p-3 justify-content-center"
...
function mostrarFormulario5() {
  ...
  generalForm.addEventListener("submit", (event) => {
    ...
    if (InfoGeneralForm.usuario == "" || InfoGeneralForm.clave == "" || InfoGeneralForm.confirm_clave == " " ||
      InfoGeneralForm.nivelA1 == "" || InfoGeneralForm.nivelI1 == "" || (!nivelA1.checked && !nivelI1.checked)) {
