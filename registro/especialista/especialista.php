      ...
      <div id="content">
        ...
        <div class="container">
          ...
          <form action="profesor.inic.php" id="Form" method="post">
            <h1 class="text-center mb-5">REGISTRO DE PROFESOR</h1>
            ...
            <div class="card">
              <div class="card-body  mr-5 ml-5">
                <div class="form-group row">
                    ...
                    <div class="col-sm-12">
                      <div class="form-group row">
                        ...
                        <div class="col">
                          ...
                          <input type="text" class="form-control" id="nombre" pattern="[a-zA-Z]*" name="nombre" require>
                        </div>

                        <div class="col">
                          <label for="apellido">Apellido</label>
                          <input type="text" class="form-control" id="apellido" pattern="[a-zA-Z]*" name="apellido" require>
                        </div>

                        <div class="col">
                          <label for="cedula">Cedula</label>
                          <input type="text" class="form-control" id="cedula" name="cedula" pattern="[0-9]*"
                          minlength="7" maxlength="9" require>
                        </div>
                  ...
                  <div class="row">
                    <div class="col-sm-12">
                      <div class="form-group row">
                        ...
                        <div class="col">
                          <label for="year">Año de servicio</label>
                          <input type="text" class="form-control" id="year" name="year"
                            pattern="[0-9]*" minlength="1" maxlength="2" require>
                        </div>
                  ...
                  <input type="hidden" class="form-control" id="grado" name="grado" value="7">
                  <input type="hidden" class="form-control" id="seccion" name="seccion" value="5">

                  <div class="col">
                    <label for="materia" class="form-label">Especialidad</label>
                    <select id="materia" name="materia" class="form-control" require>
                      <option value="0">seleccione un Materia</option>
